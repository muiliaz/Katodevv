...
export const FEATURES = [
  ...
  },
  {
    ...
    titleRu: "Пуш-уведомления",
    tags: ["community", "ondemand"],
  },
  {
    key: "dashboard",
    icon: "📊",
    titleEn: "Dashboard",
    titleRu: "Дашборд",
    tags: ["fintech", "productivity", "wellness"],
  },
  {
    key: "camera",
    icon: "📸",
    titleEn: "Camera",
    titleRu: "Камера",
    tags: ["creator", "wellness"],
  },
  {
    key: "maps",
    icon: "🗺️",
    titleEn: "Maps & Location",
    titleRu: "Карты и геолокация",
    tags: ["ondemand", "marketplace"],
  },
  {
    key: "ai",
    icon: "🧠",
    titleEn: "AI Assistant",
    titleRu: "AI-ассистент",
    tags: ["productivity", "creator"],
  },
  {
    key: "feed",
    icon: "📰",
...
export const ARCHETYPES = {
  ...
  community: {
    icon: "👥",
    titleEn: "The Community Builder",
    titleRu: "The Community Builder",
  ...
  ondemand: {
    icon: "🚚",
    titleEn: "The On-Demand",
    titleRu: "The On-Demand",
  ...
  productivity: {
    icon: "⚙️",
    titleEn: "The Productivity Tool",
    titleRu: "The Productivity Tool",
  ...
  creator: {
    icon: "🎬",
    titleEn: "The Creator Platform",
    titleRu: "The Creator Platform",
  ...
  wellness: {
    icon: "🧘",
    titleEn: "The Wellness App",
    titleRu: "The Wellness App",
  ...
  enterprise: {
    icon: "🏢",
    titleEn: "The Enterprise Tool",
    titleRu: "The Enterprise Tool",
