...
export const REAL_CASES = [
  ...
  },
  {
    ...
    title: "Drafted",
    descEn:
      "AI sharpens your resume text instead of writing from scratch. 4 templates, PDF rendered server-side.",
  ...
  },
  {
    ...
    descEn:
      "Single-product pet gear landing — size chart, photo gallery and a full checkout with live card payments, live today.",
    descRu:
      "Одностраничный лендинг под один товар для питомцев — таблица размеров, галерея и рабочий чекаут с приёмом оплаты, уже в проде.",
  ...
  },
  {
    ...
    descRu:
      "Скриншот сайта → готовый HTML/CSS за секунды. Claude Vision анализирует, код стримится.",
    url: null,
