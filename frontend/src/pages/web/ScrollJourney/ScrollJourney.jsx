 ...
 *   0–35%   hero text sucked into BH center (convergence + spaghettification)
...
export default function ScrollJourney() {
  useEffect(() => {
    ...
    // that animated them stayed — and GSAP said so, twice, in the console of
    // every visitor who opened /web ("GSAP target .hero-sidebar-left not
    // found"). Removed together with their stylesheet, which had gone dead the
    // same way. See audit-fixes/18-dead-css.md.
